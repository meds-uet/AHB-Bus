# Contributing to AHB-Bus

Thank you for your interest in contributing. Please follow these guidelines to make reviews faster and integration smoother.

Guidelines
1. Make small, focused PRs. One logical change per PR.
2. If you change `defines/parameters.svh`, update all affected RTL and testbenches and document the change.
3. Add or update testbenches in `testbench/` for any functional change. Testbenches should be named `<module>_tb.sv`.
4. Update `docs/` for any interface or behavior changes.
